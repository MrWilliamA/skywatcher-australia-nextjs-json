        ...
        <section className={Styles.productList}>
          {collapsibleDobs.length > 0 && (
            <>
              ...
              <p>
                ...
                the amateur astronomy community access to even larger apertures.
              </p>
          ...
          {tableTopDobs.length > 0 && (
            <>
              ...
              <p>
                ...
                your table! It is large enough to view night sky objects such as
                the Moon, planets, and bright nebulas and star clusters, yet
                compact enough to sit on a desk or store in your cupboard.
              </p>
          ...
          {starGateDobs.length > 0 && (
            <>
              ...
              <p>
                Sky-Watcher StarGate Dobsonians with their huge light gathering
                capabilities provide the ultimate WOW factor experience for
                aficionados of visual astronomy.
              </p>
