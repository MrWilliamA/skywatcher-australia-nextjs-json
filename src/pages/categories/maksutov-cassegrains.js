        ...
        <section className={Styles.top}>
          <div className={Styles.text}>
            ...
            <p>
              ...
              ‘take-anywhere’ telescopes. Their compact size makes them ideal if
              working space is limited. Despite their small dimensions they pack
              a powerful punch. Their High-Resolution, diffraction limited
              optical systems are multi-coated to maximise contrast and image
              sharpness.
            </p>
            ...
            <p>
              Maksutov-Cassegrains are very similar to Schmidt-Cassegrains, but
              they use convex meniscus lenses instead of corrector plates. The
              main advantage here, compared to other similar models is that
              Maksutov-Cassegrains don’t need periodic collimation as many other
              telescopic models do. In addition, because mirror obstruction is
              smaller, images appear with greater contrasts, but will have a
              narrower field of view due to the Maksutov-Cassegrain’s slow focal
              ratio which tends to make this telescope design better for
