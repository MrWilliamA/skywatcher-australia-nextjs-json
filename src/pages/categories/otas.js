      ...
      <Layout layout="boxed">
        <main className={Styles.main}>
          <div className={Styles.text}>
            ...
            <p>
              A telescope optical tube is the body of your telescope. The
              Optical Tube Assembly is often shortened to the phrase “OTA”.
              While most telescope packages offer fully equipped OTAs, there are
              many circumstances where the optical tube might be all you have.
              Perhaps you’ve built your own telescope, bought one in pieces,
              you’re working on restoring a telescope, or you’re just starting
              from ground up on building your own custom telescope assembly.
            </p>
          </div>
